...
//
//		LocalDateTime date1 = LocalDateTime.of(2020, 3, 27, 23, 50);
//		City city1 = new City("City1");
//		cityDao.save(city1);
//		Cinema cinema1 = new Cinema("cinema1", city1);
//		cinemaDao.save(cinema1);
...
//
//		LocalDateTime date1 = LocalDateTime.of(2020, 3, 27, 23, 00);
//		City city1 = new City("City1");
//		cityDao.save(city1);
//		Cinema cinema1 = new Cinema("cinema1", city1);
//		cinemaDao.save(cinema1);
...
//		billboardItem1.getItems().add(session1);
//
//		LocalDateTime date2 = LocalDateTime.of(2020, 3, 27, 23, 50);
